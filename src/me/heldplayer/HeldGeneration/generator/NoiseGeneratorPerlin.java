		...
		if (par9 == 1) {
			...
			for (int var30 = 0; var30 < par8; ++var30) {
				...
				for (var37 = 0; var37 < par10; ++var37) {
					...
					var72 = lerp(var35, func_4110_a(this.permutations[var64], var31, var38), grad(this.permutations[var22], var31 - 1.0D, 0.0D, var38));
					var71 = lerp(var35, grad(this.permutations[var64 + 1], var31, 0.0D, var38 - 1.0D), grad(this.permutations[var22 + 1], var31 - 1.0D, 0.0D, var38 - 1.0D));
				...
				for (int var44 = 0; var44 < par10; ++var44) {
					...
					for (int var51 = 0; var51 < par9; ++var51) {
						...
						if (var51 == 0 || var55 != var22) {
							...
							var29 = lerp(var42, grad(this.permutations[var73], var38, var52, var45), grad(this.permutations[var77], var38 - 1.0D, var52, var45));
							var31 = lerp(var42, grad(this.permutations[var70], var38, var52 - 1.0D, var45), grad(this.permutations[var75], var38 - 1.0D, var52 - 1.0D, var45));
							var33 = lerp(var42, grad(this.permutations[var73 + 1], var38, var52, var45 - 1.0D), grad(this.permutations[var77 + 1], var38 - 1.0D, var52, var45 - 1.0D));
							var35 = lerp(var42, grad(this.permutations[var70 + 1], var38, var52 - 1.0D, var45 - 1.0D), grad(this.permutations[var75 + 1], var38 - 1.0D, var52 - 1.0D, var45 - 1.0D));
						}
