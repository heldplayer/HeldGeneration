...
public class WorldGenBigTree extends WorldGenerator {
	 ...
	 * a given 'major' index - 1 and 2 for 0, 0
		...
		for (var11[par5] = var10[par5]; var12 <= var7; ++var12) {
			...
			while (var13 <= var7) {
				...
				if (var15 > (double) par4) {
					...
					int var14 = this.worldObj.getBlockTypeIdAt(var11[0], var11[1], var11[2]);
	 ...
	 * generate double-sized trunks by changing a
	 ...
	 * to the second, returning the distance
