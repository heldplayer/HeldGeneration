...
public class ComponentVillageField extends ComponentVillage {
	...
	public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
		...
		fillWithBlocks(par1World, par3StructureBoundingBox, 7, 0, 1, 8, 0, 7, 60, 60, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 10, 0, 1, 11, 0, 7, 60, 60, false);
		...
		fillWithBlocks(par1World, par3StructureBoundingBox, 12, 0, 0, 12, 0, 8, 17, 17, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 0, 11, 0, 0, 17, 17, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 8, 11, 0, 8, 17, 17, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 3, 0, 1, 3, 0, 7, 8, 8, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 9, 0, 1, 9, 0, 7, 8, 8, false);
		int var4;
		...
		for (var4 = 1; var4 <= 7; ++var4) {
			...
			placeBlockAtCurrentPosition(par1World, 59, MathHelper.getRandomIntegerInRange(par2Random, 2, 7), 7, 1, var4, par3StructureBoundingBox);
			placeBlockAtCurrentPosition(par1World, 59, MathHelper.getRandomIntegerInRange(par2Random, 2, 7), 8, 1, var4, par3StructureBoundingBox);
			placeBlockAtCurrentPosition(par1World, 59, MathHelper.getRandomIntegerInRange(par2Random, 2, 7), 10, 1, var4, par3StructureBoundingBox);
			placeBlockAtCurrentPosition(par1World, 59, MathHelper.getRandomIntegerInRange(par2Random, 2, 7), 11, 1, var4, par3StructureBoundingBox);
		}
