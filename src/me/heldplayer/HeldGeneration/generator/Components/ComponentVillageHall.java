...
public class ComponentVillageHall extends ComponentVillage {
	...
	public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
		...
		fillWithBlocks(par1World, par3StructureBoundingBox, 2, 0, 6, 8, 0, 10, 3, 3, false);
		placeBlockAtCurrentPosition(par1World, 4, 0, 6, 0, 6, par3StructureBoundingBox);
		fillWithBlocks(par1World, par3StructureBoundingBox, 2, 1, 6, 2, 1, 10, 85, 85, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 8, 1, 6, 8, 1, 10, 85, 85, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 3, 1, 10, 7, 1, 10, 85, 85, false);
		...
		fillWithBlocks(par1World, par3StructureBoundingBox, 8, 0, 0, 8, 3, 5, 4, 4, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 0, 7, 1, 0, 4, 4, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 5, 7, 1, 5, 4, 4, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 1, 2, 0, 7, 3, 0, 5, 5, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 1, 2, 5, 7, 3, 5, 5, 5, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 0, 4, 1, 8, 4, 1, 5, 5, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 0, 4, 4, 8, 4, 4, 5, 5, false);
		...
		placeBlockAtCurrentPosition(par1World, 85, 0, 2, 1, 3, par3StructureBoundingBox);
		placeBlockAtCurrentPosition(par1World, 72, 0, 2, 2, 3, par3StructureBoundingBox);
		placeBlockAtCurrentPosition(par1World, 5, 0, 1, 1, 4, par3StructureBoundingBox);
		placeBlockAtCurrentPosition(par1World, 53, getMetadataWithOffset(53, 3), 2, 1, 4, par3StructureBoundingBox);
		placeBlockAtCurrentPosition(par1World, 53, getMetadataWithOffset(53, 1), 1, 1, 3, par3StructureBoundingBox);
		fillWithBlocks(par1World, par3StructureBoundingBox, 5, 0, 1, 7, 0, 3, 43, 43, false);
		placeBlockAtCurrentPosition(par1World, 43, 0, 6, 1, 1, par3StructureBoundingBox);
		placeBlockAtCurrentPosition(par1World, 43, 0, 6, 1, 2, par3StructureBoundingBox);
		...
		placeBlockAtCurrentPosition(par1World, 50, 0, 6, 3, 4, par3StructureBoundingBox);
		placeDoorAtCurrentPosition(par1World, par3StructureBoundingBox, par2Random, 6, 1, 5, getMetadataWithOffset(64, 1));

		for (var6 = 0; var6 < 5; ++var6) {
			for (var7 = 0; var7 < 9; ++var7) {
				clearCurrentPositionBlocksUpwards(par1World, var7, 7, var6, par3StructureBoundingBox);
				fillCurrentPositionBlocksDownwards(par1World, 4, 0, var7, -1, var6, par3StructureBoundingBox);
			}
		}
