...
public class ComponentVillageHouse2 extends ComponentVillage {
    private static final StructurePieceTreasure[] chestLoot = new StructurePieceTreasure[] { new StructurePieceTreasure(264, 0, 1, 3, 3), new StructurePieceTreasure(265, 0, 1, 5, 10), new StructurePieceTreasure(266, 0, 1, 3, 5), new StructurePieceTreasure(297, 0, 1, 3, 15), new StructurePieceTreasure(260, 0, 1, 3, 15), new StructurePieceTreasure(257, 0, 1, 1, 5), new StructurePieceTreasure(267, 0, 1, 1, 5), new StructurePieceTreasure(307, 0, 1, 1, 5), new StructurePieceTreasure(306, 0, 1, 1, 5), new StructurePieceTreasure(308, 0, 1, 1, 5), new StructurePieceTreasure(309, 0, 1, 1, 5), new StructurePieceTreasure(49, 0, 3, 7, 5), new StructurePieceTreasure(6, 0, 3, 7, 5) };
