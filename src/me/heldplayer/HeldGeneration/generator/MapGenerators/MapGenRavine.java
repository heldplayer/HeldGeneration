...
public class MapGenRavine extends MapGenBase {
	...
	protected void recursiveGenerate(World world, int ccx, int ccz, int cx, int cz, byte[] chunkBlocks, ChunkProvider provider) {
		if (this.rand.nextInt(50) == 0) {
			double var7 = (ccx * 16 + this.rand.nextInt(16));
			double var9 = (this.rand.nextInt(this.rand.nextInt(40) + 8) + 20);
			double var11 = (ccz * 16 + this.rand.nextInt(16));
			byte var13 = 1;
			...
			for (int var14 = 0; var14 < var13; ++var14) {
				...
				generateRavine(this.rand.nextLong(), cx, cz, chunkBlocks, var7, var9, var11, var17, var15, var16, 0, 0, 3.0D, provider);
			}
		}
	}
}
